						...
						<table class="table table-striped table-hover">
							...
							<tbody data-area="workload">
								...
								<tr data-type="workload">
									...
									<td>
										<select name="mWorkloadMachineModel" class="form-control" data-type="machine">
											<% if(!info.resultMap.data[i].workLoadBackEntity[j].mWorkloadMachineModel || info.resultMap.data[i].workLoadBackEntity[j].mWorkloadMachineModel === '自动') { %>
											<option value="自动" selected>自动</option>
											<option value="手动">手动</option>
											<% } else if(info.resultMap.data[i].workLoadBackEntity[j].mWorkloadMachineModel === '手动')   { %>
											<option value="自动">自动</option>
