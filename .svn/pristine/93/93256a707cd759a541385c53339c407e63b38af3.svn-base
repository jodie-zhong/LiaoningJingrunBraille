      ...
      <div class="form-group">
        ...
        <div class="col-xs-10">
          <label class="radio-inline">
            ...
            <input type="radio" name="handleState" value="1" required checked="checked">发印
            <% } else { %>
            <input type="radio" name="handleState" value="1" required>发印
            <% } %>
          </label>
          <label class="radio-inline">
            <% if(info.handleState === '2') { %>
            <input type="radio" name="handleState" value="2" required checked="checked">快印
            <% } else { %>
            <input type="radio" name="handleState" value="2" required>快印
            <% } %>
          </label>
        </div>
      </div>
