  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group ">
        <label class="col-xs-2 control-label">装订数量</label>
        <div class="col-xs-4">
        	<input type="text" class="form-control" value="<%- info.bindingNum %>" name="bindingNum" placeholder="装订数量" maxlength="8" pattern="^[0-9]*$" data-fv-regexp-message="请输入大于0的整数" />
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group ">
        <label class="col-xs-2 control-label">装订数量</label>
        <div class="col-xs-8">
          <p class="form-control-static"><%- info.bindingNum %></p>
        </div>
      </div>
    </div>
  </div>
