							...
							<div class="row">
								<div class="col-xs-5">
									<div class="form-group">
										<label class="col-xs-4 control-label" for="inputSearchUserName">姓名</label>
										<div class="col-xs-8">
											<input type="text" maxlength="32" class="form-control" data-search="searchUserName" id="inputSearchUserName" />
										</div>
									</div>
								</div>
								<div class="col-xs-5">
