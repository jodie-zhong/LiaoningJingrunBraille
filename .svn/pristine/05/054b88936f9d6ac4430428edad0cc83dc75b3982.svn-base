...
<tr data-bookId="<%- list[i].editIdAndStateEntity.bookEditTprStatisticsId %>" data-name="<%- list[i].bookName %>"
  ...
  <!--原书出版时间版次-->
  <td class="text-center" style="width: 150px" title="<%- list[i].braileStatisticalNewPublicTime %>"><%- list[i].braileStatisticalNewPublicTime %></td>
...
<tr data-noselect="true">
  <td  colspan="49"><p class="empty-tips">没有符合指定条件的数据</p></td>
</tr>
<% } %>
