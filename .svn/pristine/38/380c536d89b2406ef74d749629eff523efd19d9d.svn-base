  ...
  <div class="row">
  	<div class="col-xs-12">
  		<div class="form-group">
  			<label class="col-xs-12" style="text-align: center;">重大选题备案登记表</label>
  		</div>
  	</div>
  </div>
  <div class="row">
      ...
      <div class="form-group">
        ...
        <div class="col-xs-8">
          <input type="text" class="form-control" value="<%- info.topicImportantFileWords %>"
                 name="topicImportantFileWords"  maxlength="8" pattern="^(([1-9][0-9]{0,3})|([0-9]\.[0-9]{1,3})|([1-9][0-9]{0,3}\.[0-9]{1,3}))$" data-fv-regexp-message="请输入小于10000的数字,允许三位小数"
