  ...
  <div class="row">
  	<div class="col-xs-12">
  		<div class="form-group">
  			<label class="col-xs-2 control-label">选题人员</label>
  			<p class="form-control-static"><%- info.topicCreateUerName %></p>
  		</div>
  	</div>
  </div>
  <% if(info.userTaskEntities) { %>
  <% for(var i = 0; i < info.userTaskEntities.length; i++) { %>
  <input type="hidden" name="currentFlowId" value="deptIssued" />
  <div class="row">
    <div class="col-xs-6">
      <div class="form-group">
