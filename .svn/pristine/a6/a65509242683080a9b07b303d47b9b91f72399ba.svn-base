	...
	<div class="row">
		<div class="col-xs-12">
			<div class="form-group">
				<label class="col-xs-2 control-label">下发意见</label>
				<div class="col-xs-10">
					<textarea class="form-control" name="handleContentOne" maxlength="2000" placeholder="下发意见(不超过2000字)"><%- info.handleContentOne %></textarea>
					<div><label class="len">0/2000</label></div>
				</div>
			</div>
		</div>
	</div>
