...
<div class="form-horizontal">
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group">
        <label class="col-xs-2 control-label">领用数量</label>
        <div class="col-xs-4">
          <input type="text" class="form-control" value="<%- info.stylebookGetNum %>" name="stylebookGetNum"
                 placeholder="领用数量" maxlength="32" pattern="^[1-9]\d*$" data-fv-regexp-message="请输入大于0的整数"
                 data-fv-notempty="true" data-fv-notempty-message="请填写领用数量"/>
        </div>
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group">
        <label class="col-xs-2 control-label">领用用途</label>
        <div class="col-xs-10">
          <textarea class="form-control" maxlength="1024" placeholder="（不超过1024字）" name="stylebookGetPurpose"><%- info.stylebookGetPurpose %></textarea>
...
<div class="form-horizontal">
  <div class="row">
    <div class="col-xs-6">
      <div class="form-group">
        <label class="col-xs-4 control-label">领取数量</label>
        <div class="col-xs-8">
          <p class="form-control-static"><%- info.stylebookGetNum %></p>
        </div>
      </div>
    </div>
    <div class="col-xs-6">
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group">
        <label class="col-xs-2 control-label">领用用途</label>
        <div class="col-xs-10">
          <pre class="form-control-static"><%- info.stylebookGetPurpose %></pre>
        </div>
      </div>
    </div>
  </div>
