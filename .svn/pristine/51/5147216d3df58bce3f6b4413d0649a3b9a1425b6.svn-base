  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group">
        ...
        <div class="col-xs-10">
          <textarea class="form-control" name="handleContentOne" maxlength="2048" placeholder="（不超过2048字）"><%-
          ...
          <table class="table table-striped table-nowrap table-hover">
            ...
            <tr data-bookPrintDetailId="<%- info.bookPrintList[i].bookPrintDetailId %>"
              ...
              <td>
                <div class="col-xs-6">
                  <div class="form-group">
                    <input type="text" name="readersServiceneedNum" class="form-control" data-fv-notempty="true"
                           pattern="^[0-9]*$" maxlength="8" data-fv-regexp-message="请输入大于等于0的整数"
                           data-fv-notempty-message="请填写所需数量"
                           value="<%- info.bookPrintList[i].readersServiceneedNum %>"/>
                  </div>
                </div>
              </td>
            </tr>
            ...
            <tr data-printId="<%- info.bookPrintList[i].bookPrintId %>"
              ...
              <td>
                <div class="input-group">
                  <p class="form-control-static"><%- info.bookPrintList[i].readersServiceneedNum %></p>
                </div>
              </td>
            </tr>
            <% } %>
