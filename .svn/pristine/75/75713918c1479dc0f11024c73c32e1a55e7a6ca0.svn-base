  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group">
        <label class="col-xs-2 control-label">处理结果</label>
        <div class="col-xs-10">
          <textarea class="form-control" name="handleContentOne" placeholder="处理结果（不超过1024字）" maxlength="1024"><%- info.handleContentOne %></textarea>
