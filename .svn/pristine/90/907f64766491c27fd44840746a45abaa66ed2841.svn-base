define(function (require, exports, module) {
    ...
    module.exports = Base.extend(new function () {
        ...
        var BATCH_AVAILABLE_FLOWS = ['qualityTestAccept', 'qualityTestReturn', 'qualityTestAudit'];
        var AVAILABLE_FLOWS = ['qualityTestCollect', 'qualityTestDistribute', 'qualityTestAccept', 'qualityTestQuality', 'qualityTestRightConfirm', 'qualityTestRightAudit', 'qualityTestModify', 'qualityTestReturn', 'qualityTestAudit'];
        var FIRST_FLOW = 'qualityTestCollect';
        var TASK_FINISHED = '2';
        var that;
        ...
        this.onCheckRowChanged = function () {
            ...
            var allMe = true, allUnfinished = true, allSameFlow = true, flowAvailable = false, batchAvailable = false;
            var userId = util.getUserInfo().userId;
            var flowId = '';
            that.$('#workListTBody').find('tr[checked]').each(function () {
                flowId = that.$(this).attr('data-flowId');
