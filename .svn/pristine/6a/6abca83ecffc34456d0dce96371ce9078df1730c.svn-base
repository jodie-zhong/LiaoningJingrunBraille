	...
	<div class="row">
		...
		<div class="col-xs-6">
			<div class="form-group ">
				...
				<div class="col-xs-8">
					<p class="form-control-static">
						<% if(!info.printState || info.printState === '1') { %> 新书
						<% } else { %> 重印
						<% } %>
					</p>
				</div>
	...
	<div class="row">
		<div class="col-xs-6">
			<div class="form-group ">
				...
				<div class="col-xs-8">
					<input type="text" class="form-control" name="printNum" value="<%- info.printNum %>" maxlength="8" pattern="^[0-9]*$" data-fv-regexp-message="请输入大于0的整数" />
				</div>
			</div>
		</div>
		<div class="col-xs-6">
			<div class="form-group ">
				...
				<div class="col-xs-8">
					<input type="text" class="form-control" name="pageNum" value="<%- info.pageNum %>" maxlength="7" pattern="^[0-9]*$" data-fv-regexp-message="请输入大于0的整数" />
				</div>
			</div>
		</div>
	</div>
			...
			<div class="form-group">
				...
				<div class="col-xs-8">
					<select name="printType" class="form-control">
						<% if(!info.printType || info.printType === '1') { %>
						<option value="1" selected>大字版</option>
						<option value="2">教材</option>
						<option value="3">普通</option>
						<% } else if(info.printType === '2') { %>
						<option value="1">大字版</option>
						<option value="2" selected>教材</option>
						<option value="3">普通</option>
	...
	<div class="row">
		...
		<div class="col-xs-6">
			<div class="form-group">
				...
				<div class="col-xs-8">
					<input type="text" class="form-control" value="<%- info.format %>" name="format" placeholder="开本" maxlength="8" pattern="^[0-9]*$" data-fv-regexp-message="请输入大于0的整数" />
				</div>
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-xs-6">
			<div class="form-group">
				...
				<div class="col-xs-8">
					<input type="text" class="form-control" value="<%- info.pricing %>" name="pricing" placeholder="定价" pattern="^(([1-9][0-9]{0,6})|([0-9]\.[0-9]{1,2})|([1-9][0-9]{0,6}\.[0-9]{1,2}))$" data-fv-regexp-message="请输入大于0小于10000000的数字（允许两位小数）" data-fv-notempty="true" data-fv-notempty-message="请输入定价" />
				</div>
			</div>
		</div>
		<div class="col-xs-6">
	...
	<div class="row">
		...
		<div class="col-xs-6">
			<div class="form-group">
				...
				<div class="col-xs-8">
					<select name="printingEnterprise" class="form-control">
						<% if(!info.printingEnterprise || info.printingEnterprise === '1') { %>
						<option value="1" selected>社内</option>
	...
	<div class="row">
		<div class="col-xs-6">
			<div class="form-group">
				...
				<div class="col-xs-8">
					<input type="text" class="form-control" value="<%- info.textPaperTotalNum %>" name="textPaperTotalNum" placeholder="正文用纸总量(令)" maxlength="10" />
				</div>
			</div>
		</div>
		<div class="col-xs-6">
	...
	<div class="row">
		...
		<div class="col-xs-6">
			<div class="form-group">
				<label class="col-xs-4 control-label">页数</label>
				<div class="col-xs-8">
					<input type="text" class="form-control" value="<%- info.colorInsertNum %>" name="colorInsertNum" maxlength="7" pattern="^[0-9]*$" data-fv-regexp-message="请输入大于0的整数" />
				</div>
			</div>
		</div>
	</div>
