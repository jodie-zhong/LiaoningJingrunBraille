...
<div class="form-horizontal">
  ...
  <div class="row">
    <div class="col-xs-6">
      <div class="form-group">
        ...
        <div class="col-xs-8">
          <% if(info.taskStage==="1"){ %>
          <p class="form-control-static">一校</p>
          <% }else if(info.taskStage==="2"){ %>
          <p class="form-control-static">二校</p>
          <% }else if(info.taskStage==="3"){ %>
          <p class="form-control-static">三校</p>
          <% } %>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-xs-6">
      <div class="form-group">
        <% if(info.taskStage==="1"){ %>
        <label class="col-xs-4 control-label">是否一校</label>
        <% }else if(info.taskStage==="2"){ %>
        <label class="col-xs-4 control-label">是否二校</label>
        <% }else if(info.taskStage==="3"){ %>
        <label class="col-xs-4 control-label">是否三校</label>
        <% } %>
        <div class="col-xs-8">
          <% if(info.handleState === '2') { %>
          <label class="radio-inline"><input type="radio" name="handleState" value="1"/>是</label>
          <label class="radio-inline"><input type="radio" name="handleState" value="2" checked/>否</label>
          <% } else { %>
          <label class="radio-inline"><input type="radio" name="handleState" value="1" checked/>是</label>
          <label class="radio-inline"><input type="radio" name="handleState" value="2"/>否</label>
          <% } %>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-xs-6">
      <div class="form-group">
        ...
        <% } %>
        <div class="col-xs-8">
          <p class="form-control-static"><%- info.handleState === '1' ? '是' : (info.handleState === '2' ? '否' : '') %></p>
        </div>
      </div>
    </div>
  </div>
