  			...
  			<div class="col-xs-10">
  				<table class="table table-striped">
                      ...
                      <button class="btn btn-default" type="button" data-open="public/file/file-upload" data-data='{"type": "*.doc, *.docx, *.pdf"}'><i class="fa fa-file-o"></i></button>
  							...
  							<td class="form-group">
  								<input type="text" class="form-control" name="hTaskPageNum" value="<%- info.fascicleList[j].hTaskPageNum %>" data-fv-notempty="true" data-fv-notempty-message="请输入分册图书页数" maxlength="7" pattern="^[0-9]*$" data-fv-regexp-message="请输入大于0的整数" />
  							</td>
