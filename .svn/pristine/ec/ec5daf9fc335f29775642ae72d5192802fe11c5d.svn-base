    ...
    <div class="col-xs-6">
      <div class="form-group">
        ...
        <div class="col-xs-8">
          ...
          <label class="radio-inline"><input type="radio" name="handleState" value="1" checked/>质检合格 </label>
          <label class="radio-inline"><input type="radio" name="handleState" value="2"/>质检不合格 </label>
          <% } else { %>
          <label class="radio-inline"><input type="radio" name="handleState" value="1"/>质检合格 </label>
          <label class="radio-inline"><input type="radio" name="handleState" value="2" checked/>质检不合格 </label>
          <% } %>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group">
        ...
        <div class="col-xs-10">
          <textarea class="form-control" name="handleContentOne" placeholder="审核意见（最大256字）" maxlength="256"><%- info.handleContentOne %></textarea>
  ...
  <div class="row">
    <div class="col-xs-6">
      <div class="form-group">
        <label class="col-xs-4 control-label">审核结果</label>
        <div class="col-xs-8">
          <p class="form-control-static"><%- info.handleState === '1' ? '质检合格' : (info.handleState === '2' ? '质检不合格' : '') %></p>
        </div>
      </div>
    </div>
  </div>
