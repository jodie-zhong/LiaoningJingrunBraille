	...
	<div class="col-xs-3">
		...
		<div class="panel panel-tree-1">
			<div class="panel-header custom-panel-header">
				<h3 class="modules-name" title="选题管理 - 选题大会"><i class="fa fa-book"></i> 选题管理 - 选题大会</h3>
			</div>
			...
			<div class="col-xs-12">
				<div class="panel panel-flow">
					<div class="panel-header custom-panel-header">
						<h3>上报列表</h3>
						<div class="control-btn">
							<button type="button" class="btn btn-xs btn-blue"  data-auth="0239" id="btnConReportChecking" disabled>选题查重</button>
