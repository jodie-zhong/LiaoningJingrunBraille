...
<div class="form-horizontal" id="formEdit">
  <div class="row">
  	<div class="col-xs-12">
  		<div class="form-group">
  			<label class="col-xs-2 control-label">签署合同</label>
  			<div class="col-xs-10">
  				<table class="table table-striped">
  					<thead>
  						<tr>
  							<th style="width: 50px;">序号</th>
  							<th>合同<span class="must-td">*</span></th>
  						...
  						<tr data-area = "contrat">
  							...
  							<td class="form-group">
  								<div class="input-group with-clear">
										<input type="text" class="form-control" name="contractFileName" value="" data-value="" placeholder="" readonly data-fv-notempty="true" data-fv-notempty-message="请选择合同附件">
										<span class="input-group-btn">
                    	<button class="btn btn-clear" type="button" data-action="clear"><i class="fa fa-remove box"></i></button>
                      <button class="btn btn-default" type="button" data-open="public/file/file-upload" data-data='{"type": "*.pdf, *.docx, *.doc, *.jpg, *.jpeg, *.png"}'><i class="fa fa-file-o"></i></button>
                    </span>
									</div>
  							</td>
  						...
  						<tr data-area = "contrat">
  							...
  							<td class="form-group">
  								<div class="input-group with-clear">
										<input type="text" class="form-control" name="contractFileName" value="<%- info.contractFileList[i].contractFileName %>" data-value="<%- info.contractFileList[i].contractFilePath %>" placeholder="" readonly data-fv-notempty="true" data-fv-notempty-message="请选择合同附件">
										<span class="input-group-btn">
                    	<button class="btn btn-clear" type="button" data-action="clear"><i class="fa fa-remove box"></i></button>
                      <button class="btn btn-default" type="button" data-open="public/file/file-upload" data-data='{"type": "*.pdf, *.docx, *.doc, *.jpg, *.jpeg, *.png"}'><i class="fa fa-file-o"></i></button>
                    </span>
  ...
  <div class="row">
    <div class="col-xs-6">
      <div class="form-group">
        <label class="col-xs-4 control-label">开始日期<span class="must">*</span></label>
        <div class="col-xs-8">
        	<input type="text" id="contractSignStartDate" class="form-control" name="contractSignStartDate" value="<%- info.contractSignStartDate %>" placeholder="开始日期" maxlength="10" data-fv-notempty="true" data-fv-notempty-message="请选择开始时间" />
        </div>
      </div>
    </div>
    <div class="col-xs-6">
      <div class="form-group">
        <label class="col-xs-4 control-label">结束日期<span class="must">*</span></label>
        <div class="col-xs-8">
        	<input type="text" id="contractSignEndDate" class="form-control" name="contractSignEndDate" value="<%- info.contractSignEndDate %>" placeholder="结束日期" maxlength="10" data-fv-notempty="true" data-fv-notempty-message="请选择结束时间" />
        </div>
      </div>
    </div>
  </div>
  				...
  				<table class="table table-striped">
  					...
  					<tbody data-wrap = "contrat">
  						...
  						<tr data-area = "contrat">
  							...
  							<% } else { %>
  							<td><button data-down="htmlView" class="btn btn-xs btn-default btn-rounded" data-address = "<%- info.contractFileList[i].contractFilePath %>" disabled>预览</button></td>
  							<td><button data-down="downView" class="btn btn-xs btn-default btn-rounded" data-address = "<%- info.contractFileList[i].contractFilePath %>" disabled>下载</button></td>	
  							<% } %>
  						</tr>
  						<% } %>
  					</tbody>
  ...
  <div class="row">
    <div class="col-xs-6">
      <div class="form-group">
        ...
        <div class="col-xs-8">
        	<p class="form-control-static"><%- info.contractSignStartDate %></p>
        </div>
      </div>
    </div>
    <div class="col-xs-6">
      <div class="form-group">
        ...
        <div class="col-xs-8">
        	<p class="form-control-static"><%- info.contractSignEndDate %></p>
        </div>
      </div>
    </div>
  </div>
