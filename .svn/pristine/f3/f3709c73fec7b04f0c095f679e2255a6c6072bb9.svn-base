...
<div class="form-horizontal">
	<div class="row">
		<div class="col-xs-12">
          ...
          <input type="radio" name="handleState" value="1" checked>同意变更
          <% } else { %>
          <input type="radio" name="handleState" value="1">同意变更
          <% } %>
        </label>
					<label class="radio-inline">
          <% if(info.handleState === '2') { %>
          <input type="radio" name="handleState" value="2" checked>不同意变更
          <% } else { %>
          <input type="radio" name="handleState" value="2">不同意变更
          <% } %>
        </label>
				</div>
			</div>
