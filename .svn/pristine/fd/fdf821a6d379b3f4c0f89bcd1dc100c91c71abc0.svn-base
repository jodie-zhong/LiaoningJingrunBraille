...
<div class="form-horizontal">
  ...
  <div class="row" data-type = "agree">
  	<div class="col-xs-12">
          ...
          <div class="input-group">
            <input type="text" class="form-control" name="sampleBookNum" value="<%- info.sampleBookNum %>" placeholder="样书数量" maxlength="8" pattern="^[0-9]*$" data-fv-regexp-message="请输入大于0的整数">
  ...
  <% if(info.userTaskEntities[i].flowId === 'cn_fillQuickPrint') { %>
      ...
      <div class="form-group">
        ...
        <div class="col-xs-8">
          <input type="text" class="form-control" name="taskUsers" title="<%- info.userTaskEntities[i].roleNames %>"
                   ...
                   data-value="<%- info.userTaskEntities[i].roleIds %>" readonly>
          </div>
      </div>
    </div>
  </div>	
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group">
        <label class="col-xs-2 control-label">样书数量</label>
        <div class="col-xs-4">
          <p class="form-control-static"><%- info.sampleBookNum %>册</p>
        </div>
      </div>
    </div>
  </div>
