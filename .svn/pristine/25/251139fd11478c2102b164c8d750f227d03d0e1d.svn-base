...
<div class="form-horizontal">
      ...
      <div class="form-group ">
        ...
        <div class="col-xs-10">
          <label class="radio-inline">
            <% if(info.handleState === '2') { %>
            <input type="radio" name="handleState" value="2" data-fv-notempty="true" data-fv-notempty-message="请选择确认结果" checked/>修改再上报
            <% } else { %>
            <input type="radio" name="handleState" value="2" data-fv-notempty="true" data-fv-notempty-message="请选择确认结果"/>修改再上报
            <% } %>
          </label>
        </div>
        <% } else { %>
        <div class="col-xs-10">
          <label class="radio-inline">
            ...
            <input type="radio" name="handleState" value="1" data-fv-notempty="true" data-fv-notempty-message="请选择确认结果" checked/>废弃选题
            <% } else { %>
            <input type="radio" name="handleState" value="1" data-fv-notempty="true" data-fv-notempty-message="请选择确认结果"/>废弃选题
            <% } %>
          </label>
          <label class="radio-inline">
            <% if(info.handleState === '2') { %>
  ...
  <div data-area="edit" style="display: none;">
    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="form-group">
          ...
          <div class="col-xs-10" id="topicType"></div>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-xs-6">
        <div class="form-group ">
          <label class="col-xs-4 control-label">推荐类型<span class="must">*</span></label>
          <div class="col-xs-8">
            <label class="radio-inline">
    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="form-group ">
          <label class="col-xs-2 control-label">中图类别<span class="must">*</span></label>
          <div class="col-xs-3">
    ...
    <input type="hidden" name="handleStateName" value="废弃选题"/>
  </div>
        ...
        <div class="col-xs-8">
          <div class="input-group with-clear">
            <input type="text" class="form-control" name="taskUsers" value="<%- info.userTaskEntities[i].nextFlowTaskUserNames %>" data-value="<%- info.userTaskEntities[i].nextFlowTaskUserIds %>"
                   placeholder="任务人" readonly data-fv-notempty="true" data-fv-notempty-message="请选择下一任务人" title="<%- info.userTaskEntities[i].nextFlowTaskUserNames %>">
            <span class="input-group-btn">
