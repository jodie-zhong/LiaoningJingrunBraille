...
<div class="form-horizontal">
    ...
    <div class="col-xs-12">
      <div class="form-group">
        ...
        <div class="col-xs-10">
          ...
          <label class="radio-inline">
            <input type="radio" name="handleState" value="2" required checked>不通过
          </label>
          <% } else { %>
          <label class="radio-inline">
            <input type="radio" name="handleState" value="1" required checked>通过
          </label>
          <label class="radio-inline">
  ...
  <div class="row" data-flow="<%- info.userTaskEntities[i].flowId %>" data-area="nextFlow" style="display: none;">
    ...
    <div class="col-xs-6" data-task-user-area="editable" style="display: none;">
    ...
    <div class="col-xs-6" data-task-user-area="unEditable" style="display: none;">
      <% if(info.userTaskEntities[i].roleIds) { %>
      <div class="form-group">
        <label class="col-xs-4 control-label">任务人</label>
        <div class="col-xs-8">
          <p class="form-control-static"><%- info.userTaskEntities[i].roleNames %></p>
          <input type="hidden" name="taskUsers" value="<%- info.userTaskEntities[i].roleNames %>" data-value="<%- info.userTaskEntities[i].roleIds %>">
        </div>
      </div>
      <% } %>
    </div>
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group">
        ...
        <div class="col-xs-10">
          <p class="form-control-static">
            <%- info.handleState === '1' ? '通过' : (info.handleState === '2' ? '不通过' : '') %>
          </p>
        </div>
      </div>
    </div>
