...
<div class="form-horizontal">
  ...
  <div class="row" data-type = "agree">
  	<div class="col-xs-12">
  		<div class="form-group">
  			<label class="col-xs-2 control-label">样书数量<span class="must">*</span></label>
  			<div class="col-xs-4">
          <div class="input-group">
            <input type="text" class="form-control" name="authorStylebookNum" value="<%- info.authorStylebookNum %>" data-fv-notempty="true"
                   placeholder="样书数量" maxlength="8" pattern="^[0-9]*$" data-fv-regexp-message="请输入大于0的整数" data-fv-notempty-message="请填写样书数量">
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group">
        ...
        <div class="col-xs-4">
          <p class="form-control-static"><%- info.authorStylebookNum %>册</p>
        </div>
      </div>
    </div>
  </div>
