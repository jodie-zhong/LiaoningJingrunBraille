  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group">
        <label class="col-xs-2 control-label">是否变更</label>
        <div class="col-xs-10">
          <label class="radio-inline">
            <% if(!info.handleState || info.handleState === '2') { %>
            <input type="radio" name="handleState" value="2"  checked>不变更
            <% } else { %>
            <input type="radio" name="handleState" value="2" >不变更
            <% } %>
          </label>
          <label class="radio-inline">
            <% if( info.handleState === '1') { %>
            <input type="radio" name="handleState" value="1"  checked>变更
            <% } else { %>
            <input type="radio" name="handleState" value="1" >变更
            <% } %>
          </label>
        </div>
      </div>
