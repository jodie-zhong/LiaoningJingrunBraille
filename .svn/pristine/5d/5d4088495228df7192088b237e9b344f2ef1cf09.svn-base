  ...
  <div class="col-xs-3">
    ...
    <div class="panel panel-tree-0">
      <div class="panel-header custom-panel-header">
        <h3 class="modules-name" title="汉文读物管理- 版权页设计"><i class="fa fa-braille"></i> 汉文读物管理- 版权页设计</h3>
      </div>
        ...
        <div class="panel panel-book-0">
          <div class="panel-header custom-panel-header">
            ...
            <div class="control-btn">
              <button type="button" class="btn btn-xs btn-primary" data-auth="05g1" id="btnCoverSingle" disabled>处理
              </button>
              <!--<button type="button" class="btn btn-xs btn-primary" data-auth="0583" id="btnCoverBach"
              disabled>批量处理</button>-->
              <button type="button" class="btn btn-xs btn-default" data-auth="05g2" id="btnCoverSearch" disabled>查看
              </button>
            </div>
          </div>
          <div class="panel-content">
