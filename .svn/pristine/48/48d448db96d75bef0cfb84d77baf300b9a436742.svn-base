  ...
  <div class="col-xs-3">
    ...
    <div class="panel panel-tree-1">
      <div class="panel-header custom-panel-header">
        <h3 class="modules-name" title="盲文读物管理 - 重印审核管理"><i class="fa fa-braille"></i> 盲文读物管理 - 重印审核管理</h3>
      </div>
        ...
        <div class="panel panel-book-1">
          <div class="panel-header custom-panel-header">
            ...
            <div class="control-btn">
              <button class="btn btn-xs btn-success" id="btnTopicAdd" data-auth="03g1" disabled>新增</button>
              <button class="btn btn-xs btn-blue" id="btnTopicModify" data-auth="03g2" disabled>修改</button>
              <button class="btn btn-xs btn-danger" id="btnTopicDelete" data-auth="03g3" disabled>删除</button>
              <button class="btn btn-xs btn-blue" id="btnTopicHandle" data-auth="03g4" disabled>处理</button>
              <button class="btn btn-xs btn-default" id="btnTopicView" data-auth="03g5" disabled>查看</button>
            </div>
          </div>
              ...
              <div class="row">
                <div class="col-xs-5">
                  <div class="form-group">
                    <label class="col-xs-4 control-label">重印名称</label>
                    <div class="col-sm-8">
            ...
            <div class="table-10 table-scroll">
              <table class="table table-striped table-hover table-nowrap" data-multi="true" id="workListTable">
                ...
                <tr>
                  ...
                  <th style="width: 20%">重印名称</th>
                  <th style="width: 20%">重印数量</th>
                  <th style="width: 20%">任务人</th>
