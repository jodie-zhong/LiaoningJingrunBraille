    ...
    <div class="col-xs-12">
      <div class="form-group">
        ...
        <div class="col-xs-10">
          ...
          <label class="radio-inline"><input type="radio" name="handleState" value="1"/>同意付印</label>
          <label class="radio-inline"><input type="radio" name="handleState" value="2" checked/>退回编辑</label>
          <% } else { %>
          <label class="radio-inline"><input type="radio" name="handleState" value="1" checked/>同意付印</label>
          <label class="radio-inline"><input type="radio" name="handleState" value="2"/>退回编辑</label>
          <% } %>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group">
        ...
        <div class="col-xs-10">
          <textarea class="form-control" name="handleContentOne" placeholder="审核意见（最大1024字）" maxlength="1024"><%- info.handleContentOne %></textarea>
  ...
  <div class="row">
    <div class="col-xs-6">
      <div class="form-group">
        ...
        <div class="col-xs-8">
          <p class="form-control-static"><%- info.handleState === '1' ? '同意付印' : (info.handleState === '2' ? '退回编辑' : '') %></p>
        </div>
      </div>
    </div>
  </div>
