	...
	<tr data-type="workload">
		...
		<td>
			<select name="mWorkloadMachineModel" class="form-control" data-type="machine">
				<option value="大份数" selected>大份数</option>
				<option value="小份数">小份数</option>
			</select>
		</td>
						...
						<table class="table table-striped table-hover">
							...
							<tbody data-area="workload">
								...
								<tr data-type="workload">
									...
									<td>
										<select name="mWorkloadMachineModel" class="form-control" data-type="machine">
											<% if(!info.resultMap.data[i].workLoadBackEntity[j].mWorkloadMachineModel || info.resultMap.data[i].workLoadBackEntity[j].mWorkloadMachineModel === '大份数') { %>
											<option value="大份数" selected>大份数</option>
											<option value="小份数">小份数</option>
											<% } else if(info.resultMap.data[i].workLoadBackEntity[j].mWorkloadMachineModel === '小份数')   { %>
											<option value="大份数">大份数</option>
											<option value="小份数" selected>小份数</option>
											<% } %>
										</select>
									</td>
