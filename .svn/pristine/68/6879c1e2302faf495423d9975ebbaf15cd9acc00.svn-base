        ...
        <div class="col-xs-10">
          <table class="table table-striped table-nowrap table-hover">
            ...
            <tr>
              ...
              <td>
                <% if(info.reportList[i].hBookFileAddress && info.reportList[i].hBookFileAddress !=='') { %>
                ...
                <% } else { %>
                <button class="btn btn-xs btn-default btn-rounded downloadFile" data-download-address="<%- info.reportList[i].hBookFileAddress %>" disabled>下载</button>
                <% } %>
              </td>
            </tr>
            <% } %>
        ...
        <div class="col-xs-10">
          <table class="table table-striped table-hover table-nowrap">
            ...
            <tr>
              ...
              <td><%- info.fileList[i].hBookFileType === '1' ? '汉文书稿' : (info.fileList[i].hBookFileType === '5' ? '汉文封面' : (info.fileList[i].hBookFileType === '22' ? '版权页设计' : '')) %></td>
              ...
              <td>
                ...
                <% if(info.fileList[i].hBookFileAddress) { %>
                <button style="margin: 0;" class="btn btn-xs btn-default btn-rounded preview" data-download-address="<%- info.fileList[i].hBookFileAddress %>">预览</button>
                <% } else { %>
                <button style="margin: 0;" class="btn btn-xs btn-default btn-rounded preview" disabled>预览</button>
                <% } %>
                <% } %>
              </td>
            </tr>
