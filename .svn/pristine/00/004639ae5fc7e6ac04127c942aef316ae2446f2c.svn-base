...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="col-xs-2">
            <p class="form-control-static"><%- list[i].topicDetailName %></p>
        </div>
        <div class="col-xs-4 enter-book" data-id="<%- list[i].topicId %>" data-name="<%- list[i].topicDetailName %>">
        ...
        <div class="col-xs-4">
            ...
            <div class="form-group undetermined-personal">
                <div class="input-group with-clear" >
                    <input type="text" class="form-control" name="taskUsers" title="<%- list[i].taskUserNames %>"
