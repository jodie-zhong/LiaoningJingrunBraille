  ...
  <div class="row">
    <div class="col-xs-6">
      <div class="form-group">
        ...
        <div class="col-xs-8">
          <input class="form-control" name="contractTemplateName" value="<%- info.contractTemplateName %>" maxlength="16" placeholder="模板名称" data-fv-notempty="true" data-fv-notempty-message="请填写模板名称">
        </div>
      </div>
    </div>
    <div class="col-xs-6">
      ...
      <div class="form-group">
        ...
        <div class="col-xs-8 input-group with-clear" style="padding: 0 4px 0 15px;">
          ...
          <span class="input-group-btn">
            ...
            <button class="btn btn-default" type="button" style="padding-left: 15px;" data-open="public/file/file-upload" data-data='{"type": "*.doc,*.docx"}'><i class="fa fa-file-o"></i></button>
          </span>
        </div>
      </div>
    </div>
