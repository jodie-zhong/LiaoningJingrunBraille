define(function (require, exports, module) {
    ...
    var Item = ItemBase.extend({
        ...
        getFormData:function () {
            ...
            // 发行初审
            $form.find('div[data-flow="cn_coverSecond"]').each(function () {
                var $el=$(this);
            ...
            // 责编初审
            $form.find('div[data-flow="cn_coverEditorSecond"]').each(function () {
                var $el=$(this);
        ...
        initPageEvent: function () {
            ...
            this.$container.on('click','.downCopyRight',function () {
                var $el=$(this);
                if($el.attr('data-address')){
                    window.open(util.getServerBase() + 'common/downloadFile.action?path=' + encodeURIComponent($el.attr('data-address')), '_blank');
                }
        ...
        initPageData: function () {
            var $input=this.$('div[data-flow="cn_coverSecond"]').find('input[type="text"]');
