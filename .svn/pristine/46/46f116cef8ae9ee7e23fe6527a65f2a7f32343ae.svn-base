define(function (require, exports, module) {
    ...
    var listTpl =
        ...
        "      <div class='col-xs-12'>" +
        "        <input class='form-control' value='<%- list[i].page %>' name='page' placeholder='页码' pattern='^[1-9]\\d{0,3}$' data-fv-regexp-message='请输入大于0的整数，<br>最大4位' data-fv-notempty='true' data-fv-notempty-message='请填写页码'/>" +
        "      </div>" +
        "    </div>" +
        "  </td>" +
        "  <td>" +
        "    <div class='form-group'>" +
        "      <div class='col-xs-12'>" +
        "        <input class='form-control' value='<%- list[i].line %>' name='line' placeholder='行'pattern='^[1-9]\\d{0,1}$' data-fv-regexp-message='请输入大于0的整数，<br>最大2位' data-fv-notempty='true' data-fv-notempty-message='请填写行'/>" +
        "      </div>" +
        "    </div>" +
        "  </td>" +
        "  <td>" +
