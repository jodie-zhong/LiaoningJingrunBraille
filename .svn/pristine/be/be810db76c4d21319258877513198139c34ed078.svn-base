  ...
  <div class="col-xs-3">
    ...
    <div class="panel panel-tree-0">
      <div class="panel-header custom-panel-header">
        <h3 class="modules-name" title="盲文读物管理 - 清样稿管理"><i class="fa fa-book"></i>盲文读物管理 - 清样稿管理</h3>
      </div>
        ...
        <div class="panel panel-book-0">
          <div class="panel-header custom-panel-header">
            ...
            <div class="control-btn">
              <button class="btn btn-xs btn-blue" id="btnDeal" disabled data-auth="0381">处理</button>
              <button class="btn btn-xs btn-blue" id="btnDealBatch" disabled data-auth="0382">批量处理</button>
              <button class="btn btn-xs btn-default" id="btnView" disabled data-auth="0383">查看</button>
            </div>
          </div>
