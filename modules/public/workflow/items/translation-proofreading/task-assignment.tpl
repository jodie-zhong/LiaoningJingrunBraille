  ...
  <div class="row">
    <div class="col-xs-6">
      <div class="form-group">
        ...
        <div class="col-xs-8">
          <p class="form-control-static"><%- info.auditCenterWordOne %>X<%- info.auditCenterWordTwo %></p>
        </div>
      </div>
    </div>
    <div class="col-xs-6">
  ...
  <div class="row">
    <div class="col-xs-6">
      <div class="form-group">
        ...
        <div class="col-xs-8">
          <p class="form-control-static"><%- info.auditWorkway === '1' ? '录入' : (info.auditWorkway === '2' ? '转换' : '') %></p>
        </div>
      </div>
    </div>
  </div>
