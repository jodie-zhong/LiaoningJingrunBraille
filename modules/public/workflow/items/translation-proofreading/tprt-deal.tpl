      ...
      <div class="form-group">
        ...
        <div class="col-xs-8">
          <select style="width: 155px;" name="onlineProofFascicule" class="form-control" title="分册">
            ...
            <option value="<%- info.bookFascicleList[i].bookFascicleId %>" data-book-upload-type="<%- info.bookFascicleList[i].bookUploadType %>"><%- info.bookFascicleList[i].bookFascicleBookName %></option>
            <% } %>
          </select>
          <% if(info.bookFascicleList && info.bookFascicleList.length > 0 && info.bookFascicleList[0].bookUploadType === '2') { %>
          <button style="margin: 0 0 0 10px;" class="btn btn-xs btn-default" name="onlineProof" data-bookId="<%- info.bookId %>" data-taskId="<%- info.taskId %>">在线校对</button>
          <% } else { %>
          <button style="margin: 0 0 0 10px;" class="btn btn-xs btn-default" name="onlineProof" data-bookId="<%- info.bookId %>" data-taskId="<%- info.taskId %>" disabled>在线校对</button>
          <% } %>
        </div>
      </div>
    </div>
