define(function (require, exports, module) {
    ...
    module.exports = ItemBase.extend({
        ...
        getFormData: function () {
            ...
            params.inputVersionList = this.data.info.bookFascicleList;
            for (var i = 0; i < params.inputVersionList.length; i++) {
                params.inputVersionList[i].bookFilePath = params.inputVersionList[i].bookFileAddress;
            }
            return params;
        },
