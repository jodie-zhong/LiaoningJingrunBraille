  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group">
        <label class="col-xs-2 control-label" style="margin-top: -2px;"><%- info.flowName %>文稿及版数表</label>
          ...
          <div class="form-group">
            <table class="table table-striped table-hover table-nowrap">
              ...
              <tr>
                ...
                <th style="width: 100px;">册数</th>
                <th style="width: 120px;">字数（千字）<span class="must-td">*</span></th>
              ...
              <tr data-fascicule-id="<%- info.bookFascicleList[i].bookFascicleId %>" data-book-upload-type="<%- info.bookFascicleList[i].bookUploadType %>">
                ...
                <td>
                  <div class="col-xs-12">
                    <div class="form-group">
                      <input class="form-control" value="<%- info.bookFascicleList[i].tprQualityWordNum %>" name="tprQualityWordNum" placeholder="<%- info.flowName %>字数（千字）"
                             data-fv-notempty="true" data-fv-notempty-message="请填写<%- info.flowName %>字数（千字）" pattern="^(([1-9][0-9]{0,3})|([0-9]\.[0-9]{1,3})|([1-9][0-9]{0,3}\.[0-9]{1,3}))$"
                             data-fv-regexp-message="请输入小于10000的<br>数字,允许三位小数"/>
                    </div>
                  </div>
                </td>
                <td>
                ...
                <td>
                  <div class="input-group with-clear">
                    <input minlength="1" class="form-control" name="uploadFile" value="<%- info.bookFascicleList[i].bookFileName %>" placeholder="请选择文件"
