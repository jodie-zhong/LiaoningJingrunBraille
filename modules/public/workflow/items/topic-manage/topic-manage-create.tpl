    ...
    <div class="row">
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-8">
            <input class="form-control" value="<%- info.topicDetailOldName %>" name="topicDetailOldName" placeholder="原书名称" data-fv-notempty-message="请填写原书名称"
                   maxlength="128"/>
          </div>
        </div>
      </div>
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-8">
            <input class="form-control" value="<%- info.topicDetailOldPublishingHouse %>" name="topicDetailOldPublishingHouse" placeholder="原出版社" data-fv-notempty-message="请填写原出版社" maxlength="128"/>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="form-group">
          ...
          <div class="col-xs-10">
            <textarea class="form-control" name="topicDetailContentValidity" placeholder="内容简介（不超过1024字）" maxlength="1024"
    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="form-group">
          ...
          <div class="col-xs-10">
            <textarea class="form-control" name="topicDetailContentAuthor" placeholder="作者简介（不超过1024字）" maxlength="1024"
