...
<script type="text/template" id="workRowTemplate">
	<tr data-type="workload">
		...
		<td class="form-group"><input type="text" class="form-control" name="mWorkloadMachineModel" maxlength="16" /></td>
						...
						<table class="table table-striped table-hover">
							...
							<tbody data-area="workload">
								...
								<tr data-type="workload">
									...
									<td class="form-group"><input type="text" class="form-control" name="mWorkloadMachineModel" value="<%- info.resultMap.data[i].workLoadBackEntity[j].mWorkloadMachineModel %>" maxlength="16" /></td>
					...
					<table class="table table-striped table-hover">
						...
						<tbody>
							...
							<tr data-type="workload">
								...
								<td>
									<%- info.resultMap.data[i].workLoadBackEntity[j].mWorkloadMachineModel %>
								</td>
								<td>
