...
<div class="form-horizontal" id="formEdit">
	<input type="hidden" name="printState" value="<%- info.printState %>" />
	<div class="row">
		<input type="hidden" value="<%- info.checkPage %>" name="checkPage" />
		<div class="col-xs-6">
			<div class="form-group">
				<label class="col-xs-4 control-label">封面印刷<br />完成时间</label>
				<div class="col-xs-8">
					<p class="form-control-static" style="margin-top: 9px;">
						<%- info.finishDatetime %>
					</p>
				</div>
			</div>
		...
		<div class="col-xs-6">
			<div class="form-group">
				<label class="col-xs-4 control-label">封面印刷<br />完成数量</label>
				<div class="col-xs-8">
					<p class="form-control-static" style="margin-top: 9px;">
						<%- info.coverPrintingCount %>
					</p>
				</div>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-xs-12">
			<div class="form-group">
				<label class="col-xs-2 control-label">封面印刷<br />处理人</label>
				<div class="col-xs-4">
					<p class="form-control-static" style="margin-top: 9px;">
						<%- info.finishUserName %>
					</p>
