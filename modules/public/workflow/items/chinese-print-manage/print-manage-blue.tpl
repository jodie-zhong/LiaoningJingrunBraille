      ...
      <div class="form-group ">
        ...
        <div class="col-xs-10">
          <label class="radio-inline">
            <% if(!info.bluePaperPrintState || info.bluePaperPrintState === '1') { %>
            <input type="radio" name="bluePaperPrintState" value="1" checked/>印制中
            <% } else { %>
            <input type="radio" name="bluePaperPrintState" value="1"/>印制中
            <% } %>
          </label>
          <label class="radio-inline">
            <% if(info.bluePaperPrintState === '2') { %>
            <input type="radio" name="bluePaperPrintState" value="2" checked/>已完成
            <% } else { %>
            <input type="radio" name="bluePaperPrintState" value="2"/>已完成
            <% } %>
          </label>
        </div>
      </div>
  ...
  <div class="row">
  	<div class="col-xs-6">
  		<div class="form-group">
  			...
  			<div class="col-xs-8">
  				<input type="text" id="bluePaperPrintTime" class="form-control date-time" maxlength="10" value="<%- info.bluePaperPrintTime %>" name="bluePaperPrintTime" placeholder="交付印制时间" />
  			</div>
  		</div>
  	</div>
  	<div class="col-xs-6">
