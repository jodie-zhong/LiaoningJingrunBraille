  ...
  <div class="row" data-type = "agree">
  	<div class="col-xs-6">
  		<div class="form-group">
  			...
  			<div class="col-xs-8">
  				<input type="text" class="form-control" name="libraryStorageLocation" value="<%- info.libraryStorageLocation %>" placeholder="图书入库地点" maxlength="10" />
  			</div>
  		</div>
  	</div>
  	<div class="col-xs-6">
  		<div class="form-group">
  			...
  			<div class="col-xs-8">
  				<input type="text" class="form-control" name="libraryStoragePhone" value="<%- info.libraryStoragePhone %>" placeholder="电话" maxlength="13" pattern="(^(0\d{2,3}-\d{7,8})$)|(^0[1-9]\d{8,10}$)|(^[1-9]\d{6,7}$)|(^1[3|4|5|7|8][0-9]\d{8}$)" data-fv-regexp-message="请输入正确的电话号码" />
  			</div>
  		</div>
  	</div>
  </div>
