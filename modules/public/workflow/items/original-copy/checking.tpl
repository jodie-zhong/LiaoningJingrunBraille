    ...
    <div class="col-xs-6">
      <div class="form-group">
        ...
        <div class="col-xs-8">
          ...
          <label class="radio-inline"><input type="radio" name="handleState" value="2"/>未通过</label>
          <% } else { %>
          <label class="radio-inline"><input type="radio" name="handleState" value="1"/>通过</label>
          <label class="radio-inline"><input type="radio" name="handleState" value="2" checked/>未通过</label>
          <% } %>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-xs-6">
      <div class="form-group">
        <label class="col-xs-4 control-label">审核结果</label>
        <div class="col-xs-8">
          <p class="form-control-static"><%- info.handleState === '1' ? '通过' : '未通过' %></p>
        </div>
      </div>
    </div>
  </div>
