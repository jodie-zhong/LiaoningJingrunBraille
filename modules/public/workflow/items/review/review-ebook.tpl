...
<div class="form-horizontal" id="formEdit">
	...
	<div class="row">
			...
			<div class="form-group">
				...
				<div class="col-xs-8">
					<div class="input-group with-clear">
						<input type="text" class="form-control" data-name="bookFileName" value="<%- info.coverList[i].bookFileName %>" title="<%- info.coverList[i].bookFileName %>" data-value="<%- info.coverList[i].bookFileAddress %>" placeholder="<%- info.coverList[i].bookFileTypeName %>" readonly/>
		...
		<div class="col-xs-6">
			...
			<button data-type = "down" class="btn btn-primary" disabled>下载</button>
			<% } else { %>
			<button data-type = "down" class="btn btn-primary">下载</button>
			<% } %>
		</div>
	</div>
	<% } %>
