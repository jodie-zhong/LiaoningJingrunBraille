...
<div class="form-horizontal">
  <input type="hidden" name="currentFlowId" value="finalAudit" />
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group ">
        ...
        <div class="col-xs-10">
          <label class="radio-inline">
            ...
            <input type="radio" name="handleState" value="1" required data-required-error="请选择复审结果" checked/>同意发稿
            <% } else { %>
            <input type="radio" name="handleState" value="1" required data-required-error="请选择复审结果"/>同意发稿
            <% } %>
          </label>
          <label class="radio-inline">
            <% if(info.handleState === '2') { %>
            <input type="radio" name="handleState" value="2" required data-required-error="请选择复审结果" checked/>退编辑
            <% } else { %>
            <input type="radio" name="handleState" value="2" required data-required-error="请选择复审结果"/>退编辑
            <% } %>
          </label>
        </div>
      </div>
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group">
        ...
        <div class="col-xs-10">
          <textarea class="form-control" name="handleContentOne" placeholder="终审意见（不超过2048字）" maxlength="2048"><%- info.handleContentOne %></textarea>
