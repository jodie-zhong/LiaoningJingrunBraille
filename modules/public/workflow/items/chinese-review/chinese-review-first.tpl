...
<div class="form-horizontal" id="formEdit">
	...
	<div class="row">
		<div class="col-xs-12">
			<div class="form-group">
				...
				<div class="col-xs-10">
					<% if(info.bookSampleList.length === 0) { %>
	...
	<div class="row" data-area="opinion">
		<div class="col-xs-12">
			<div class="form-group">
				<label class="col-xs-2 control-label">初审意见<span class="must">*</span></label>
				<div class="col-xs-10">
					<textarea class="form-control" name="handleContentOne" placeholder="初审意见(不少于500字，且不超过1024字)" minlength="500" maxlength="1024" data-fv-notempty="true" data-fv-notempty-message="请填写初审意见"><%- info.handleContentOne %></textarea>
					<div><label class="len">0/1024</label></div>
				</div>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-xs-12">
			<div class="form-group">
				<label class="col-xs-2 control-label">录排人</label>
				<div class="col-xs-4">
					<input type="text" class="form-control" value="<%- info.mwHAuditProofread.typographicUserName %>" title="<%- info.mwHAuditProofread.typographicUserName %>" placeholder="录排人" readonly>
					<input type="hidden" value="<%- info.mwHAuditProofread.typographicUser %>" name="typographicUser">
				</div>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-xs-12">
			<div class="form-group">
				<label class="col-xs-2 control-label">录排人</label>
				<div class="col-xs-10">
					<p class="form-control-static"><%- info.mwHAuditProofread.typographicUserName %></p>
				</div>
			</div>
		</div>
	</div>
