  ...
  <div class="row">
  	<div class="col-xs-12">
  		<div class="form-group">
  			<label class="col-xs-2 control-label" style="top: 0;">引进版权<br />合同登记号<span class="must">*</span></label>
  			<div class="col-xs-4">
  				<input type="text" class="form-control" value="<%- info.topicIntroduceCode %>" name="topicIntroduceCode" placeholder="引进版权合同登记号" maxlength="32" data-fv-notempty="true" data-fv-notempty-message="请填写引进版权合同登记号" />
  			</div>
  		</div>
  	</div>
  </div>
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group">
        ...
        <div class="col-xs-10">
          <textarea class="form-control" name="handleContentOne" maxlength="2048" placeholder="备案信息(不超过2048字)"><%- info.handleContentOne %></textarea>
...
<div class="form-horizontal">
  <div class="row">
  	<div class="col-xs-12">
  		<div class="form-group">
  			<label class="col-xs-2 control-label">引进版权<br />合同登记号</label>
  			<div class="col-xs-4">
  				<p class="form-control-static"><%- info.topicIntroduceCode %></p>
  			</div>
  		</div>
  	</div>
  </div>
