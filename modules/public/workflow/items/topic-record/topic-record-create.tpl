...
<div class="form-horizontal">
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group">
        <label class="col-xs-2 control-label">备案选题<span class="must">*</span></label>
        <div class="col-xs-4">
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group">
        <label class="col-xs-2 control-label">备案方式</label>
        <div class="col-xs-10">
          <label class="radio-inline">
            <% if(info.topicSelectProperty === '2') { %>
            <input type="radio" name="topicSelectProperty" value="2" data-fv-notempty="true" data-fv-notempty-message="请选择备案方式" checked>重大选题备案
            <% } else { %>
            <input type="radio" name="topicSelectProperty" value="2" data-fv-notempty="true" data-fv-notempty-message="请选择备案方式">重大选题备案
            <% } %>
          </label>
          <label class="radio-inline">
            <% if(info.topicSelectProperty === '3') { %>
            <input type="radio" name="topicSelectProperty" value="3" data-fv-notempty="true" data-fv-notempty-message="请选择备案方式" checked>引用选题备案
            <% } else { %>
            <input type="radio" name="topicSelectProperty" value="3" data-fv-notempty="true" data-fv-notempty-message="请选择备案方式">引用选题备案
            <% } %>
          </label>
        </div>
      </div>
  ...
  <div data-area="import" style="display: none;">
        ...
        <div class="form-group">
          ...
          <div class="col-xs-8">
            <input type="text" class="form-control" name="topicImportantFileName" value="<%- info.BrailleBigTopicRecord.topicImportantFileName %>" data-value="<%- info.bookTopicId %>" maxlength="32"
                   placeholder="选题名称" readonly data-fv-notempty="true" data-fv-notempty-message="请选则选题名称"/>
          </div>
        </div>
      </div>
      <div class="col-xs-6">
    ...
    <div class="row">
      <div class="col-xs-6">
        <div class="form-group">
          <label class="col-xs-4 control-label" style="top: 0;">字/幅数<br>（千字/幅）</label>
          <div class="col-xs-8">
      ...
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-8">
            <input type="text" class="form-control" value="<%- info.BrailleBigTopicRecord.planPublicationTime %>" name="planPublicationTime" placeholder="拟出版时间" maxlength="32"/>
          </div>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-xs-6">
        <div class="form-group">
          <label class="col-xs-4 control-label" style="top: 0;">涉及重大<br>选题类别</label>
          <div class="col-xs-8">
          	<select class="form-control" name="topicImportantFileType" id="topicImportantFileType"></select>
          </div>
        </div>
      </div>
      <div class="col-xs-6">
    ...
    <div class="row">
        ...
        <div class="form-group">
          ...
          <div class="col-xs-8">
            <p class="form-control-static">
              <%- info.BrailleBigTopicRecord.userTaskEntities[i].flowName %>（<%- info.BrailleBigTopicRecord.userTaskEntities[i].deptAndRoles %>）
            </p>
      ...
      <div class="col-xs-6">
        ...
        <div class="form-group">
          ...
          <div class="col-xs-8">
            <div class="input-group with-clear">
              <input type="text" class="form-control" name="taskUsers" title="<%- info.BrailleBigTopicRecord.userTaskEntities[i].nextFlowTaskUserNames %>" value="<%- info.BrailleBigTopicRecord.userTaskEntities[i].nextFlowTaskUserNames %>"
    ...
    <div class="row">
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-8">
            <input type="text" class="form-control" name="bookName" value="<%- info.BrailleImportedTopicRecord.bookName %>" maxlength="64" placeholder="作品名称(原文)" readonly/>
          </div>
        </div>
      </div>
      <div class="col-xs-6">
    ...
    <div class="row">
      ...
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-8">
            <input type="text" class="form-control" value="<%- info.BrailleImportedTopicRecord.publishDatetime %>" name="publishDatetime" placeholder="原作品出版日期" maxlength="32"/>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-8">
            <input type="text" class="form-control date-time" value="<%- info.BrailleImportedTopicRecord.contractSignDate %>" name="contractSignDate" placeholder="合同签订日期" maxlength="10"/>
          </div>
        </div>
      </div>
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-8">
            <input type="text" class="form-control date-time" value="<%- info.BrailleImportedTopicRecord.contractEffectiveDate %>" name="contractEffectiveDate" placeholder="合同有效日期" maxlength="10"/>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-8">
            <input type="text" class="form-control" value="<%- info.BrailleImportedTopicRecord.minPrint %>" name="minPrint" placeholder="最低印数" maxlength="8" pattern="^[1-9][0-9]*$"
    ...
    <div class="row">
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-8">
            <p class="form-control-static">
              <%- info.BrailleImportedTopicRecord.userTaskEntities[i].flowName %>（<%- info.BrailleImportedTopicRecord.userTaskEntities[i].deptAndRoles %>）
            </p>
      ...
      <div class="col-xs-6">
        ...
        <div class="form-group">
          ...
          <div class="col-xs-8">
            <div class="input-group with-clear">
              <input type="text" class="form-control" name="taskUsers" title="<%- info.BrailleImportedTopicRecord.userTaskEntities[i].nextFlowTaskUserNames %>" value="<%- info.BrailleImportedTopicRecord.userTaskEntities[i].nextFlowTaskUserNames %>"
