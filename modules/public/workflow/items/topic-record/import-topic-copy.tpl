  ...
  <div class="row">
  	<div class="col-xs-12">
  		<div class="form-group">
  			<label class="col-xs-2 control-label">重大选题备案号<span class="must">*</span></label>
  			<div class="col-xs-4">
  				<input type="text" class="form-control" name="topicImportantCode" value="<%- info.topicImportantCode %>" maxlength="32" placeholder="重大选题备案号" data-fv-notempty="true" data-fv-notempty-message="请填写重大选题备案号" />
  			</div>
  		</div>
  	</div>
  </div>
...
<div class="form-horizontal">
  <div class="row">
  	<div class="col-xs-12">
  		<div class="form-group">
  			<label class="col-xs-2 control-label">重大选题备案号</label>
  			<div class="col-xs-4">
  				<p class="form-control-static"><%- info.topicImportantCode %></p>
  			</div>
  		</div>
  	</div>
  </div>
