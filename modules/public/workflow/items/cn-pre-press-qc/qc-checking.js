define(function (require, exports, module) {
    ...
    module.exports = ItemBase.extend({
        ...
        getFormData: function () {
            ...
            // if (this.$("input[name='handleState']:checked").val() === '1') {
            //     params.listNext = [];
            //     this.$("div[data-index='2'],div[data-index='1']").each(function () {
            ...
            if (this.$("input[name='handleState']:checked").val() === '1') {
                ...
                params.listNext = [];
                if (tmpList[0].flowId === "cn_qualityCoverModify") {
                    params.listNext.push(tmpList[0]);
                    params.listNext.push(tmpList[1]);
                } else if (tmpList[1].flowId === "cn_qualityCoverModify") {
                    params.listNext.push(tmpList[1]);
                    params.listNext.push(tmpList[0]);
                } else {
                    params.listNext = tmpList;
                }
            }
            return params;
        },
