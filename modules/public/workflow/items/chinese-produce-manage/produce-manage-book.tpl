  ...
  <div class="row">
  	<div class="col-xs-6">
  		<div class="form-group">
  			...
  			<div class="col-xs-8">
  				<input type="text" id="sampleBookPrintTime" class="form-control date-time" maxlength="10" value="<%- info.sampleBookPrintTime %>" name="sampleBookPrintTime" placeholder="交付印制时间" readonly />
  			</div>
  		</div>
  	</div>
  	<div class="col-xs-6">
