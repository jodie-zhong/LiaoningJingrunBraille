define(function (require, exports, module) {
    ...
    var Item = ItemBase.extend({
        ...
        onHandleChange: function () {
            ...
            if (handle === '1') {
                // 通过
                this.$('div[data-flow="cn_IssueReview"]').show();
                this.$('div[data-flow="cn_OfficeReview"]').show();
                // 生产通知单
                this.$('div[data-flow="cn_production"]').show();
            } else {
                this.$('div[data-flow="cn_PrintedNotice"]').show();
            }
        },
