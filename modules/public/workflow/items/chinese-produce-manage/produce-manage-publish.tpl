...
<div class="form-horizontal">
  ...
  <div class="row">
  	<div class="col-xs-12">
  		<div class="form-group">
  			<label class="col-xs-2 control-label" style="margin-top: -15px;">建议印刷的<br />印场名称</label>
  			<div class="col-xs-4">
          <input type="text" class="form-control" name="printFactory" value="<%- info.printFactory %>"
                   placeholder="建议印刷的印场名称" maxlength="10">
        </div>
  		</div>
  	</div>
  </div>
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group">
        <label class="col-xs-2 control-label" style="margin-top: -15px;">建议印刷的<br />印场名称</label>
        <div class="col-xs-4">
          <p class="form-control-static"><%- info.printFactory %></p>
        </div>
      </div>
    </div>
  </div>
