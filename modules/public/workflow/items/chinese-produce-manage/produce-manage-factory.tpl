  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group ">
        <label class="col-xs-2 control-label">交付印厂状态</label>
        <div class="col-xs-10">
          <label class="radio-inline">
            <% if(!info.handleState || info.handleState === '1') { %>
            <input type="radio" name="handleState" value="1" checked/>已交付
            <% } else { %>
            <input type="radio" name="handleState" value="1"/>已交付
            <% } %>
          </label>
          <label class="radio-inline">
            <% if(info.handleState === '2') { %>
            <input type="radio" name="handleState" value="2" checked/>未交付
            <% } else { %>
            <input type="radio" name="handleState" value="2"/>未交付
            <% } %>
          </label>
        </div>
      </div>
