...
<div class="form-horizontal">
      ...
      <div class="form-group ">
        ...
        <div class="col-xs-10">
          <label class="radio-inline">
            ...
            <input type="radio" name="handleState" value="1" checked/>同意印制
            <% } else { %>
            <input type="radio" name="handleState" value="1"/>同意印制
            <% } %>
          </label>
          <label class="radio-inline">
            <% if(info.handleState === '2') { %>
            <input type="radio" name="handleState" value="2" checked/>退责任印制
            <% } else { %>
            <input type="radio" name="handleState" value="2"/>退责任印制
            <% } %>
          </label>
        </div>
      </div>
  ...
  <% if(info.userTaskEntities[i].flowId === 'cn_leadershipAudit') { %>
    ...
    <div class="col-xs-6">
      ...
      <div class="form-group">
        ...
        <div class="col-xs-8">
          ...
          value="<%- info.userTaskEntities[i].roleNames %>" data-value="<%- info.userTaskEntities[i].roleIds %>">
        </div>
      </div>
      <% } %>
    </div>
