define(function (require, exports, module) {
    ...
    var Item = ItemBase.extend({
        ...
        getFormData:function () {
            ...
            if(handle==='1'){
                $form.find('div[data-flow="cn_firstTaskStart"]').each(function () {
                    var $el=$(this);
                    params.handleContentTwo=$el.find('input[name="taskUsers"]').attr('data-value');
                });
            }
            $form.find('div[data-flow="rpt_bookPrintingTaskAllocation"]').each(function () {
                var $el=$(this);
        ...
        onHandleChange: function () {
            ...
            if (handle === '2') {
                // 否
                this.$('div[data-flow="cn_firstTaskStart"]').hide();
            }else{
                this.$('div[data-flow="cn_firstTaskStart"]').show();
            }
        },
        ...
        initPageData: function () {
            this.onHandleChange();
            var $input=this.$('div[data-flow="cn_firstTaskStart"]').find('input[type="text"]');
