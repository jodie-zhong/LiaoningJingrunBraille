...
<div class="form-horizontal" id="formEdit">
  ...
  <input type="hidden" name="hReprintBookAnditId" value="<%- info.hReprintBookAnditId %>">
  <input type="hidden" name="taskId" value="<%- info.taskId %>">
  <input type="hidden" name="inputState" value="<%- info.inputState %>">
  <input type="hidden" name="hBookPrintState" value="<%- info.hBookPrintState %>">
  <input type="hidden" name="parentBookId" value="<%- info.parentBookId %>">
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group">
        ...
        <div class="col-xs-10">
          <label class="radio-inline">
            ...
            <input type="radio" name="handleState" value="1" required checked="checked">同意
            <% } else { %>
            <input type="radio" name="handleState" value="1" required>同意
            <% } %>
          </label>
          <label class="radio-inline">
            <% if(info.handleState === '2') { %>
            <input type="radio" name="handleState" value="2" required checked="checked">放弃
            <% } else { %>
            <input type="radio" name="handleState" value="2" required>放弃
            <% } %>
          </label>
        </div>
      </div>
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group">
        ...
        <div class="col-xs-10">
          <textarea class="form-control" maxlength="1024" placeholder="（不超过1024字）" name="auditContent"><%-
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group">
        <label class="col-xs-2 control-label">部门讨论会意见</label>
        <div class="col-xs-10">
          <textarea class="form-control" maxlength="1024" placeholder="（不超过1024字）" name="deptDiscussContent"><%-
            info.handleContentTwo
            %></textarea>
          <div><label class="len"></label></div>
        </div>
      </div>
