			...
			<div class="form-group">
				...
				<div class="col-xs-4">
					<div class="input-group with-clear">
						<input type="text" class="form-control" name="bookCipSynopsis" value="<%- info.bookCipSynopsis %>" title="<%- info.bookCipSynopsis %>" placeholder="CIP信息" data-fv-notempty="true" data-fv-notempty-message="请上传CIP信息" readonly />
              ...
              <button class="btn btn-default" type="button" data-bookId = "<%- info.bookId %>" data-name = "bookCipSynopsis" style="width: auto;">上传</button>
				...
				<div class="col-xs-6">
					...
					<button class="btn btn-default" data-type = "down" type="button" data-bookId = "<%- info.bookId %>">下载</button>	
					<% } else { %>
