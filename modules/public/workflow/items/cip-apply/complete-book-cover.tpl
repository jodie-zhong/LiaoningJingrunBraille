  ...
  <div class="row">
    <table class="table table-striped table-hover table-nowrap">
      ...
      <tr data-type="ebook" data-id="<%- info.bookFascicleList[i].bookTopicId %>"
        ...
        <td><%- (i + 1) %></td>
        <td title="<%- info.bookFascicleList[i].bookFascicleName %>"><%- info.bookFascicleList[i].bookFascicleName %></td>
        <td title="<%- info.bookFascicleList[i].bookFileType %>"><%- info.bookFascicleList[i].bookFileType %></td>
        <td title="<%- info.bookFascicleList[i].bookFileName %>" class="book-file-type" data-bookFileType="<%- info.bookFascicleList[i].bookFileTypeCode  %>"><%-
          info.bookFascicleList[i].bookFileName %></td>
        <td>
          ...
          <button class="btn btn-default btn-sm m-t-5 btn-rounded btn-download"
                  data-download="<%- info.bookFascicleList[i].bookFileAddress %>" disabled>下载
          </button>
  ...
  <div class="row">
    <table class="table table-striped table-hover table-nowrap">
      ...
      <tr data-id="<%- info.bookFascicleList[i].bookTopicId %>"
        ...
        <td title="<%- info.bookFascicleList[i].bookFascicleName %>"><%- info.bookFascicleList[i].bookFascicleName %></td>
        <td title="<%- info.bookFascicleList[i].bookFileType %>"><%- info.bookFascicleList[i].bookFileType %></td>
        <td title="<%- info.bookFascicleList[i].bookFileName %>"><%- info.bookFascicleList[i].bookFileName %></td>
        <td>
          <% if(!info.bookFascicleList[i].bookFileAddress || info.bookFascicleList[i].bookFileAddress === '') { %>
          <button class="btn btn-default btn-sm m-t-5 btn-rounded btn-download"
                  data-download="<%- info.bookFascicleList[i].bookFileAddress %>" disabled>下载
