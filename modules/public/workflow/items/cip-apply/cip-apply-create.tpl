      ...
      <div class="form-group">
        ...
        <div class="col-xs-10">
          <textarea type="text" class="form-control" name="bookDetailSketched"
                              maxlength="1024" placeholder="内容提要（不超过1024字）" ><%- info.bookDetailSketched%></textarea>
          <div><label class="len"></label></div>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-xs-6">
      <div class="form-group">
        ...
        <div class="col-xs-8">
          <input type="text" class="form-control bookFasciclePrice"
                 pattern="^(([1-9][0-9]{0,7})|([0-9]\.[0-9]{1,2})|([1-9][0-9]{0,7}\.[0-9]{1,2}))$"
                 data-fv-regexp-message="输入整数不超过8位且大于0的数(允许两位小数)" value="<%- info.bookFasciclePrice %>"
                 name="bookFasciclePrice"
                 placeholder="定价（本册）"/>
        </div>
      </div>
    </div>
      ...
      <div class="form-group">
        ...
        <div class="col-xs-8">
          <input type="text" class="form-control" value="<%- info.bookPressName %>" name="bookPressName"
                 placeholder="出版社名称" maxlength="32"/>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-xs-6">
      <div class="form-group">
        <label class="col-xs-4 control-label">其他作者</label>
        <div class="col-xs-8">
          <p class="form-control-static"><%- info.bookDetailOtherAuthor %></p>
        </div>
      </div>
    </div>
    <div class="col-xs-6">
      <div class="form-group">
        <label class="col-xs-4 control-label">其他著作方式</label>
        <div class="col-xs-8">
          <p class="form-control-static"><%- info.bookDetailOtherWorkWay %></p>
        </div>
      </div>
    </div>
  </div>
