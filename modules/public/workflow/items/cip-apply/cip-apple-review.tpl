      ...
      <div class="form-group">
        ...
        <div class="col-xs-10">
          <label class="radio-inline">
            ...
            <input type="radio" name="handleState" value="1" required checked="checked">同意申请
            <% } else { %>
            <input type="radio" name="handleState" value="1" required>同意申请
            <% } %>
          </label>
          <label class="radio-inline">
            <% if(info.handleState === '2') { %>
            <input type="radio" name="handleState" value="2" required checked="checked">不同意申请
            <% } else { %>
            <input type="radio" name="handleState" value="2" required>不同意申请
            <% } %>
          </label>
        </div>
      </div>
