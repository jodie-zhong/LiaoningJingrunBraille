  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group">
        <label class="col-xs-2 control-label">复审结果</label>
        <div class="col-xs-10">
          <% if(info.handleState === '2') { %>
          <label class="radio-inline"><input type="radio" name="handleState" value="1"/>建议录排</label>
          <label class="radio-inline"><input type="radio" name="handleState" value="2" checked/>退编辑</label>
          <% } else { %>
          <label class="radio-inline"><input type="radio" name="handleState" value="1" checked/>建议录排</label>
          <label class="radio-inline"><input type="radio" name="handleState" value="2"/>退编辑</label>
          <% } %>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group">
        ...
        <div class="col-xs-10">
          <textarea class="form-control" name="handleContentOne" placeholder="复审意见（最大1024字）" maxlength="1024"><%- info.handleContentOne %></textarea>
...
<div class="form-horizontal">
  <div class="row">
    <div class="col-xs-6">
      <div class="form-group">
        ...
        <div class="col-xs-8">
          <p class="form-control-static"><%- info.handleState === '1' ? '建议录排' : (info.handleState === '2' ? '退编辑' : '') %></p>
        </div>
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col-xs-6">
      <div class="form-group">
        <label class="col-xs-4 control-label">复审意见</label>
        <div class="col-xs-8">
