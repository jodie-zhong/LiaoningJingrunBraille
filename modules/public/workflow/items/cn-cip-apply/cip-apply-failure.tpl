      ...
      <div class="form-group">
        ...
        <div class="col-xs-10">
          <label class="radio-inline">
            ...
            <% } else { %>
            <input type="radio" name="handleState" value="1" required>再次申请
            <% } %>
          </label>
          <label class="radio-inline">
            <% if(info.handleState === '2') { %>
            <input type="radio" name="handleState" value="2" required checked>流程终止
            <% } else { %>
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group">
        ...
        <div class="col-xs-10">
          <textarea class="form-control" maxlength="1024" placeholder="(不超过1024个字)" name="handleContentOne"><%-
