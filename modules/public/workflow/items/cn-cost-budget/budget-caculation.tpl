  ...
  <div class="row">
    <div class="col-xs-6">
      <div class="form-group">
        <label class="col-xs-4 control-label">印制成本</label>
        <div class="col-xs-8">
          <input class="form-control" value="<%- info.cnBookPrintEntity.pringCost %>" name="pringCost" placeholder="印制成本" pattern="^\d{0,8}(\.\d{1,2})?$"
                 data-fv-regexp-message="请输入0~99999999的数字，最大2位小数"/>
        </div>
      </div>
    </div>
    <div class="col-xs-6">
      <div class="form-group">
        <label class="col-xs-4 control-label" style="padding: 0;">建议印刷的印厂名称</label>
        <div class="col-xs-8">
          <input class="form-control" value="<%- info.cnBookPrintEntity.printFactory %>" name="printFactory" placeholder="建议印刷的印厂名称" maxlength="16"/>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-xs-6">
      <div class="form-group">
        <label class="col-xs-4 control-label">印制成本</label>
        <div class="col-xs-8">
          <p class="form-control-static"><%- info.cnBookPrintEntity.pringCost %></p>
        </div>
      </div>
    </div>
    <div class="col-xs-6">
      <div class="form-group">
        <label class="col-xs-4 control-label" style="padding: 0;">建议印刷的印厂名称</label>
        <div class="col-xs-8">
          <p class="form-control-static"><%- info.cnBookPrintEntity.printFactory %></p>
        </div>
      </div>
    </div>
  </div>
