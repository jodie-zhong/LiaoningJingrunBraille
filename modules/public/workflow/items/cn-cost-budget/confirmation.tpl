...
<div class="form-horizontal">
  <div class="row">
    <div class="col-xs-6">
      <div class="form-group">
        ...
        <div class="col-xs-8">
          <% if(info.printCostConfirmEntity.handleState == 2) { %>
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group">
        ...
        <div class="col-xs-10">
          <textarea class="form-control" name="handleContentOne" placeholder="复确认意见（最大256字）" maxlength="256"><%- info.printCostConfirmEntity.handleContentOne %></textarea>
  ...
  <div class="row" data-area="nextFlow" data-index="<%- i %>" style="display: none">
    <div class="col-xs-6">
      <div class="form-group">
  ...
  <div class="row">
    <div class="col-xs-6">
      <div class="form-group">
        <label class="col-xs-4 control-label">确认结果</label>
        <div class="col-xs-8">
          <p class="form-control-static"><%- info.printCostConfirmEntity.handleState==1 ? '没问题' : (info.printCostConfirmEntity.handleState==2 ? '有问题' : '') %></p>
        </div>
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group">
        <label class="col-xs-2 control-label">复确认意见</label>
        <div class="col-xs-10">
          <p class="form-control-static"><%- info.printCostConfirmEntity.handleContentOne %></p>
        </div>
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col-xs-6">
      <div class="form-group">
        ...
        <div class="col-xs-8">
          <p class="form-control-static"><%- info.printCostConfirmEntity.submitUserName %></p>
        </div>
      </div>
    </div>
    <div class="col-xs-6">
      <div class="form-group">
        ...
        <div class="col-xs-8">
          <p class="form-control-static"><%- info.printCostConfirmEntity.submitDatetime %></p>
        </div>
      </div>
    </div>
  </div>
