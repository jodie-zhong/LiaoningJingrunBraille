        ...
        <div class="col-xs-10">
          <table class="table table-striped table-nowrap table-hover">
            ...
            <tr>
              ...
              <td title="<%- info.bookFascicleEntities[i].bookFileTypeName %>"><%- info.bookFascicleEntities[i].bookFileTypeName %></td>
              <td class="bookFileName"><%- info.bookFascicleEntities[i].bookFileName %></td>
              <td>
        ...
        <div class="col-xs-10">
          <table class="table table-striped table-nowrap table-hover">
            ...
            <tr>
              ...
              <td title="<%- info.bookFascicleEntities[i].bookFascicleBookName %>"><%- info.bookFascicleEntities[i].bookFascicleBookName %></td>
              <td title="<%- info.bookFascicleEntities[i].bookFileTypeName %>"><%- info.bookFascicleEntities[i].bookFileTypeName %></td>
              <td class="bookFileName" title="<%- info.bookFascicleEntities[i].bookFileName %>"><%- info.bookFascicleEntities[i].bookFileName %></td>
              <td>
                <% if(info.bookFascicleEntities[i].bookFileAddress && info.bookFascicleEntities[i].bookFileAddress !== '') { %>
                <button class="btn btn-xs btn-default btn-rounded downloadSeparated" data-download-address="<%- info.bookFascicleEntities[i].bookFileAddress %>">下载</button>
                <% } else { %>
