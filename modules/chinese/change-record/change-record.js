define(function (require, exports, module) {
    ...
    var FLOW_APPLY = 'cn_changeTheRecordsApplication'; // 变更备案申请表
    var FLOW_EXAMINE = 'cn_examine'; // 部门负责人审核
    var FLOW_SIGN = 'cn_sign' // 总编辑/副总编辑签署
    var FLOW_REGISTER = 'cn_registrationRecord' // 备案登记
    var FLOW_INFORM = 'cn_informDutyEditor' // 告知责编

    var Module = Base.extend(new function () {
        var that;

        this.deployKey = 'CNChangeRecord';
        ...
        this.taskListAction = 'CNchangeRecord/cnSearchChangeRecordList.action';
