	...
	<div class="col-xs-3">
		<div class="panel panel-tree-0">
			<div class="panel-header custom-panel-header">
				<h3 class="modules-name" title="汉文读物管理- 变更备案"><i class="fa fa-language"></i> 汉文读物管理- 变更备案</h3>
			</div>
				...
				<div class="panel panel-book-0">
					<div class="panel-header custom-panel-header">
						...
						<div class="control-btn">
							<button class="btn btn-xs btn-primary" id="btnChangeHandle" data-auth="0571" disabled>处理</button>
							<button class="btn btn-xs btn-primary" id="btnChangeBatch" data-auth="0572" disabled>批量处理</button>
							<button class="btn btn-xs btn-default" id="btnChangeCheck" data-auth="0573" disabled>查看</button>
						</div>
					</div>
