  ...
  <div class="col-xs-3">
    ...
    <div class="panel panel-tree-0">
      <div class="panel-header custom-panel-header">
        <h3 class="modules-name" title="汉文读物管理 - 印前质检管理"><i class="fa fa-book"></i>汉文读物管理 - 印前质检管理</h3>
      </div>
        ...
        <div class="panel panel-book-0">
          <div class="panel-header custom-panel-header">
            ...
            <div class="control-btn">
              <button class="btn btn-xs btn-blue" id="btnDeal" disabled data-auth="0591">处理</button>
              <button class="btn btn-xs btn-default" id="btnView" disabled data-auth="0592">查看</button>
            </div>
          </div>
          <div class="panel-content">
            <div class="table-10">
