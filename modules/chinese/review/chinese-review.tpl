  ...
  <div class="col-xs-3">
    ...
    <div class="panel panel-tree-0">
      <div class="panel-header custom-panel-header">
        <h3><i class="fa fa-language"></i>汉文读物管理 - 审稿</h3>
      </div>
        ...
        <div class="panel panel-book-0">
          <div class="panel-header custom-panel-header">
            ...
            <div class="control-btn">
            	<button class="btn btn-xs btn-primary" id="btnReviewHandle" data-auth="0531" disabled>处理</button>
              <button class="btn btn-xs btn-default" id="btnReviewCheck" data-auth="0532" disabled>查看</button>
            </div>
          </div>
          <div class="panel-content">
            <div class="table-10">
