  ...
  <div class="col-xs-3">
    ...
    <div class="panel panel-tree-0">
      <div class="panel-header custom-panel-header">
        <h3 class="modules-name" title="汉文读物管理 - 图书排版"><i class="fa fa-book"></i>汉文读物管理 - 图书排版</h3>
      </div>
        ...
        <div class="panel panel-book-0">
          <div class="panel-header custom-panel-header">
            ...
            <div class="control-btn">
              <button class="btn btn-xs btn-blue" id="btnDeal" data-auth="0521" disabled>处理</button>
              <button class="btn btn-xs btn-default" id="btnView" data-auth="0523" disabled>查看</button>
            </div>
          </div>
          <div class="panel-content">
            <div class="table-10">
