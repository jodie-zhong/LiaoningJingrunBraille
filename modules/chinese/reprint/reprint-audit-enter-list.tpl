...
<div class="row">
  <div class="col-xs-12">
    <div class="form-group">
      ...
      <div class="col-xs-10">
          <textarea class="form-control" maxlength="1024" placeholder="（不超过1024字）" name="auditContent"><%- info.handleContentOne
            %></textarea>
      </div>
    </div>
  </div>
...
<div class="row">
  <div class="col-xs-12">
    <div class="form-group">
      ...
      <div class="col-xs-10">
          <textarea class="form-control" maxlength="1024" placeholder="（不超过1024字）" name="deptDiscussContent"><%- info.handleContentTwo
            %></textarea>
      </div>
    </div>
  </div>
...
<div class="dialog-options">
  <button class="btn btn-default" id="btnEnter">录入完成</button>
</div>