  ...
  <div class="col-xs-3">
    ...
    <div class="panel panel-tree-0">
      <div class="panel-header custom-panel-header">
        <h3 class="modules-name" title="汉文读物管理 - 书号和CIP号申请"><i class="fa fa-language"></i> 汉文读物管理 -
          书号和CIP号申请</h3>
      </div>
        ...
        <div class="panel panel-book-0">
          <div class="panel-header custom-panel-header">
            ...
            <div class="control-btn">
              <button class="btn btn-xs btn-primary" data-auth="0551" id="btnCipSingle" disabled>处理</button>
              <button class="btn btn-xs btn-primary" data-auth="0552" id="btnCipBatch" disabled>批量处理</button>
              <button class="btn btn-xs btn-default" data-auth="0553" id="btnCipSearch" disabled>查看</button>
            </div>
          </div>
          <div class="panel-content">
            <div class="table-10">
              <table class="table table-striped table-nowrap table-hover" data-multi="true" id="workListTable">
                ...
                <tr>
                  ...
                  <th style="width: 16%">图书名称</th>
                  <th style="width: 16%">图书类型</th>
                  <th style="width: 16%">责任编辑</th>
                  <th style="width: 16%">书号</th>
                  <th style="width: 16%">任务人</th>
                  <th style="width: 16%">申请状态</th>
                </tr>
                </thead>
