  ...
  <div class="modal-content">
    <div class="panel">
      <div class="panel-header">
        <h3><i class="fa fa-user-o"></i> 添加图书</h3>
      ...
      <div class="panel-content">
        <div class="table-10-static">
          <table class="table table-striped table-nowrap table-hover" id="selectBookContainer">
            <thead>
            <tr>
            ...
            <tbody id="selectBookTbody">

            </tbody>
          </table>
        </div>
        <div class="dialog-options">
          <button type="button" class="btn btn-primary" id="btnBookCheckSelect">选择</button>
        </div>
      </div>
    </div>
  </div>
