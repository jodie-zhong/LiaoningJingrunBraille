  ...
  <div class="col-xs-3">
    ...
    <div class="panel panel-tree-0">
      <div class="panel-header custom-panel-header">
        <h3 class="modules-name" title="盲文读物管理- 封面设计及印刷"><i class="fa fa-braille"></i> 盲文读物管理- 封面设计及印刷</h3>
      </div>
        ...
        <div class="panel panel-book-0">
          <div class="panel-header custom-panel-header">
            ...
            <div class="control-btn">
              <button type="button" class="btn btn-xs btn-primary" data-auth="03c1" id="btnCoverSingle" disabled>处理</button>
              <button type="button" class="btn btn-xs btn-default" data-auth="03c2" id="btnCoverSearch" disabled>查看</button>
            </div>
          </div>
          <div class="panel-content">
            <div class="table-10">
