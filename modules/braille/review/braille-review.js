define(function(require, exports, module) {
	...
	var FLOW_OTHERFIRST = 'otherFirstAudit' // 盲文审稿
	...
	var Module = Base.extend(new function() {
		...
		this.onCheckRowChanged = function() {
			...
			if(count === 1) {
				...
				if(allMe && allUnfinished && (allDeptIssued || allFirstAudit || allOtherFirst || allSecondAudit || allFinalAudit || allUploadEbook)) {
