...
<tr data-id="<%- list[i].topicMeetingId %>" data-signFlag="<%- list[i].signFlag %>" data-name="<%- list[i].topicMeetingName %>" data-state="<%-list[i].topicMeetingState %>" data-number="<%- list[i].topicMeetingNum %>">
  <td><%- (i + 1) %></td>
