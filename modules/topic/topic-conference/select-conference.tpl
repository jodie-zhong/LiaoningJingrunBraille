  ...
  <div class="modal-content">
    <div class="panel dialog-resize">
          ...
          <div class="row">
            <div class="col-xs-5">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input class="form-control" type="text" name="searchTopicDetailName" id="searchTopicDetailName"
                         data-search="searchTopicDetailName"/>
                </div>
              </div>
            </div>
            <div class="col-xs-5">
      ...
      <div class="panel-content">
          <table class="table table-striped table-nowrap table-top" data-multi="true" id="selectTopicReportTable">
            <thead>
            <tr>
